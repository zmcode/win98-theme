...
var chord_audio = new Audio("/static/themes/win98/static/audio/chord.mp3");
...
window.showMessageBox = window.showMessageBox || (({
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        $("<div>").append(
            $("<img width='32' height='32'>").attr("src", `/static/themes/win98/static/img/icons/${iconID}-32x32-8bpp.png`).css({
                margin: "16px",
                display: "block",
            }),
            $message
